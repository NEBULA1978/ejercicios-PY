def mis_peliculas(peliculas):
    for pelicula in peliculas:
        para_mostrar = f'"{pelicula["titulo"]} de {pelicula["director"]}"'
        if pelicula["vista"]:
            print("Ya has visto:", para_mostrar)
        else:
            print("Te falta por ver:", para_mostrar)
    return peliculas

# Array de diccionarios
coleccion_de_peliculas = [
    {
...
mis_peliculas(coleccion_de_peliculas)
